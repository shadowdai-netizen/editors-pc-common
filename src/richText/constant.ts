...
export const simpleConfig = { ...baseConfig, height: 500, plugins, toolbar: simpleToolBar };

export const fullConfig = { ...baseConfig, height: '100%', plugins, toolbar: fullToolBar };
